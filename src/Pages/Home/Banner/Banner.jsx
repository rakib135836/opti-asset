        ...
        <div className="flex justify-center ">
            <Carousel className="max-h-[700px] my-10">
                <div className="relative h-[700px]">
                    <img src="https://i.ibb.co/j6BjNBp/windows-k-RWY72-TKB0-Y-unsplash.jpg" className="object-cover h-full w-full" />
                ...
                <div className="relative h-[700px]">
                    <img src="https://i.ibb.co/TBPJnCw/hunters-race-MYbh-N8-Kaa-Ec-unsplash.jpg" className="object-cover h-full w-full" />
                    <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white p-4 rounded text-center">
                        <p>Join as a HR</p>
